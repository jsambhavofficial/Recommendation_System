...
def handle_conversational_intent(query):
    ...
    help_queries = ["help", "guide me", "how to use", "what can you do", "guide", "can you help"]

    # Check for exact matches or sentence starters
    if any(query == g or query.startswith(g + " ") for g in greetings):
        return "Hello! I am your AI Course Recommendation Assistant. Tell me what skills or domains you want to learn!"
    elif any(query == g or query.startswith(g + " ") for g in gratitude):
        return "You're very welcome! Let me know if you need any more course recommendations."
    elif any(h in query for h in help_queries):
        return "I can help you find the best courses! Try asking me things like: 'I want to learn Python and Java' or 'Show me beginner cybersecurity courses'."
